...
public class PassengerMain04 {
    ...
    public static void main(String[] args) {
        ...
        QueuePassenger04 queuePassenger = new QueuePassenger04(max);
        ...
        do {
            ...
            switch (choose) {
                case 1:
                    ...
                    Passenger04 p = new Passenger04(nm, cOrg, cDes, ticket, price);
                    sc.nextLine();
                    queuePassenger.Enqueue(p);
                    break;
                case 2:
                    Passenger04 data = queuePassenger.Dequeue();
